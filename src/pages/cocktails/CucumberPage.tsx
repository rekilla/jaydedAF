...
const lifestyleScenes = [
  {
    id: 'intimate',
    title: 'Garden Party',
    subtitle: 'Light sips, lively conversations',
...
// Destination Data
const destinations = [
  { id: 'miami', name: 'Hamptons Afternoon', video: '/videos/miami-nights.mp4' }, // Placeholder
  { id: 'manhattan', name: 'Kyoto Garden', video: '/videos/manhattan-rooftop.mp4' }, // Placeholder
  { id: 'malibu', name: 'Bali Retreat', video: '/videos/malibu-sunset.mp4' } // Placeholder
];
      ...
      <section className="relative h-screen min-h-[600px] w-full overflow-hidden">
        ...
        <div className="relative z-10 h-full flex items-center justify-center">
          <div className="text-center px-4 w-full">
            ...
            >
              <img 
                src="/images/cocktails/cucmber/bottle-hero.png" 
                alt="Cucumber Bottle"
      ...
      <InView as="section" className="relative py-16 sm:py-20 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <p className="text-base sm:text-lg md:text-xl text-brand-text/70 max-w-2xl mx-auto">
            From the first crisp aroma to the last smooth finish, experience a journey crafted for those who seek tranquility.
          </p>
        </div>
      </InView>
      ...
      <InView as="section" className="py-20 bg-gradient-to-b from-black to-brand-dark/20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            >
              <div className="w-20 h-20 mx-auto mb-4 rounded-full bg-gradient-to-br from-emerald-400/20 to-emerald-600/20 flex items-center justify-center">
                <span className="text-3xl">🥒</span>
              </div>
              <h3 className="font-heading text-xl text-brand-gold mb-2">Initial</h3>
              <p className="text-brand-text/70">Cool cucumber awakens your senses</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-brand-text/70">A hint of mint and botanicals</p>
            </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center max-w-6xl mx-auto">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-base sm:text-lg text-brand-text/80 mb-6 sm:mb-8">
                The art of the pour, the anticipation of the first sip. Each bottle of Laxly Cucumber is an invitation to slow down and savor life's golden moments.
              </p>
      ...
      <InView as="section" className="py-20 bg-gradient-to-b from-brand-dark/20 to-black">
        <div className="container mx-auto px-4">
          <h2 className="font-heading text-4xl sm:text-5xl text-center text-brand-gold mb-4">
            Where Will Laxly Cucumber Take You?
          </h2>
